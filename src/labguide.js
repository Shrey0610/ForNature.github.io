...
const ImageClassifier = ({ onPrediction }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('imagefile', imageFile); // Ensure consistency with the server-side key name
...
function Labguide() {
    ...
    const handleImagePrediction = (prediction) => {
        // Set the predicted value as the prompt for the chatbot
...
<div className="container px-4 py-5" id="featured-3">
  ...
  <div className="row g-4 py-5 row-cols-1 row-cols-lg-3">
    ...
    <div className="feature col">
      ...
      <p>
        <b>
        Finally through API endpoint the output is displayed in the form of text.</b>
      </p>
